...
export async function POST(req) {
  ...
  if (projectName.length > 50) return Response.json({ data: null, error: "Project name too long!" });
  
  if (projectName.length < 1) return Response.json({ data: null, error: "Project name too short!" });
